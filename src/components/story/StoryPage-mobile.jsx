  ...
  const pageImages = React.useMemo(() => [
    {
      id: 0,
      name: "표지",
      backgroundImage: `/Story/Page/${language}/1.svg`,
    },
    {
      id: 1,
      name: "페이지 1",
      backgroundImage: `/Story/Page/${language}/2.svg`,
    },
    {
      id: 2,
      name: "페이지 2",
      backgroundImage: `/Story/Page/${language}/3.svg`,
    },
    {
      id: 3,
      name: "페이지 3",
      backgroundImage: `/Story/Page/${language}/4.svg`,
    },
    {
      id: 4,
      name: "페이지 4",
      backgroundImage: `/Story/Page/${language}/5.svg`,
    },
    {
      id: 5,
      name: "페이지 5",
      backgroundImage: `/Story/Page/${language}/6.svg`,
    },
  ], [language]);
